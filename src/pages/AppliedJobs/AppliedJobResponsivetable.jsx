...
const AppliedJobResponsivetable = ({job}) => {
    ...
    return (
        ...
        <h2 className="text-black text-2xl">{job?.JobTitle}</h2>
          ...
          <div className="flex justify-between  ">
                <p className="text-gray-500 w-1/2 "> Job Category:</p>

                <p className="text-gray-500 w-1/2 text-end">{job?.JobCategory}</p>
              </div>
              <div className="flex justify-between   ">
...
export default AppliedJobResponsivetable;